...
class HelloWorldModelTest {
    ...
    private static final String defaultTitle = "Author title field";
    private static final String defaultText = "Author text field";
    ...
    @Test
    void testGetDefaultTitle() throws Exception {
        String title = hello.getTitle();
        assertNotNull(title);
        assertEquals(defaultTitle,title);
    }

    @Test
    void testGetDefaultText() throws Exception {
